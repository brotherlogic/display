...
func (s *Server) handler(ctx context.Context, title, artist, image, extra string) error {
	...
	<meta http-equiv="refresh" content="60">
      <body>
		<div id="container">	
			...
			<section id="main">
				<img class="art_image" src="image.jpeg" width="10" height="10">
				<div class="text">
	...
	output, err2 := exec.Command("/usr/bin/convert", "/media/scratch/display/image-raw.jpeg", "-resize", "500x500", "/media/scratch/display/image.jpeg").CombinedOutput()
	if err2 != nil {
